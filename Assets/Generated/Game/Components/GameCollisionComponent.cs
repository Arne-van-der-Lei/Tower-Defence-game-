...
public partial class GameEntity {
    ...
    public Components.CollisionComponent collision { get { return (Components.CollisionComponent)GetComponent(GameComponentsLookup.Collision); } }
    public bool hasCollision { get { return HasComponent(GameComponentsLookup.Collision); } }

    public void AddCollision(UnityEngine.Collider newCollider) {
        var index = GameComponentsLookup.Collision;
        var component = CreateComponent<Components.CollisionComponent>(index);
        component.collider = newCollider;
        AddComponent(index, component);
    }

    public void ReplaceCollision(UnityEngine.Collider newCollider) {
        var index = GameComponentsLookup.Collision;
        var component = CreateComponent<Components.CollisionComponent>(index);
        component.collider = newCollider;
